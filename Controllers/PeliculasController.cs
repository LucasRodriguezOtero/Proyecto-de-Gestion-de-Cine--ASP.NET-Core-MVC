...
namespace TP_FINAL_GRUPO_C.Controllers
{
    ...
    public class PeliculasController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ID,Nombre,Descripcion,Sinopsis,Poster,Duracion")] Pelicula pelicula)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ID,Nombre,Descripcion,Sinopsis,Poster,Duracion")] Pelicula pelicula)
        {
            if (id != pelicula.ID)
            {
                return NotFound();
